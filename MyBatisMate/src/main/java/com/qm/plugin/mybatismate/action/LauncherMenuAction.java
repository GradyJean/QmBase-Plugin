package com.qm.plugin.mybatismate.action;
...
import com.qm.plugin.mybatismate.launcher.PluginLauncher;
...
public class LauncherMenuAction extends AnAction {
    ...
    public @NotNull ActionUpdateThread getActionUpdateThread() {
        return ActionUpdateThread.EDT; // 或 ActionUpdateThread.BGT，根据你的操作是否需要在 UI 线程执行
    }
}
